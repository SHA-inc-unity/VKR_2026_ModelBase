...
def _direct_strategy_robustness_payload(strategy: Dict[str, Any] | None) -> Dict[str, Any]:
    ...
    return {
        ...
        "final_holdout_guard_applied": bool(strategy.get("final_holdout_guard_applied", strategy.get("final_holdout_safeguard_applied", False))),
        "final_holdout_guard_reason": strategy.get("final_holdout_guard_reason"),
        "final_holdout_delta_vs_baseline": _safe_float(strategy.get("final_holdout_delta_vs_baseline")),
        "final_holdout_candidate_before_guard": dict(strategy.get("final_holdout_candidate_before_guard", {}) or {}),
        "final_holdout_candidate_after_guard": dict(strategy.get("final_holdout_candidate_after_guard", {}) or {}),
