...
`/api/queue/history`: `POST /api/kafka` сохраняет туда только крупные
...
`correlationId` и, если применимо, выбранной биржей. Источник хранится
...
`running/queued` без ручного refresh страницы.
