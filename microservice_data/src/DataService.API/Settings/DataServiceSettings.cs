...
public sealed class PostgresSettings
{
    ...
    public string ConnectionString =>
        // Pool budget: _heavyConcurrency(8) × ~5 parallel detector connections ≈ 40 heavy
        // + a few light handlers → 50 keeps headroom above this service's concurrency model.
        $"Host={Host};Port={Port};Database={Database};Username={User};Password={Password};Pooling=true;MinPoolSize=1;MaxPoolSize=50;CommandTimeout=60";
}
