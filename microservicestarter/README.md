...
Если backend host/IP не передан аргументом, launcher в интерактивном режиме
спросит его и сохранит в `microservice_admin/.env` как `ONLINE_BACKEND_HOST`,
а затем автоматически выведет из него:
