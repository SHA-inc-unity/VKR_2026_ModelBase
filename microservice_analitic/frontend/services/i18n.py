...
_T: dict[str, dict[str, str]] = {
    ...
    "download.btn_export_csv":  {"ru": "💾 Экспорт в CSV",      "en": "💾 Export to CSV"},
    ...
    # ── Query history (download page) ─────────────────────────────────────
    "download.qh_title":        {"ru": "История запросов к базе данных",
                                  "en": "Database query history"},
    "download.qh_empty":        {"ru": "История пуста. Выполните проверку покрытия или загрузку данных.",
                                  "en": "No history yet. Run a coverage check or download."},
    "download.qh_clear":        {"ru": "🗑 Очистить историю",   "en": "🗑 Clear history"},
    "download.qh_time":         {"ru": "Время",                 "en": "Time"},
    "download.qh_action":       {"ru": "Действие",              "en": "Action"},
    "download.qh_params":       {"ru": "Параметры",             "en": "Parameters"},
    "download.qh_result":       {"ru": "Результат",             "en": "Result"},
    "download.qh_duration":     {"ru": "Длительность",          "en": "Duration"},
    "download.qh_sql":          {"ru": "SQL / операция",        "en": "SQL / operation"},
    "download.qh_act_check":    {"ru": "Проверка покрытия",     "en": "Coverage check"},
    "download.qh_act_download": {"ru": "Загрузка пропусков",    "en": "Download missing"},
    "download.qh_in_progress":  {"ru": "в процессе",            "en": "in progress"},
    "download.qh_interrupted":  {"ru": "прервано",              "en": "interrupted"},
    "download.qh_error":        {"ru": "ошибка",                "en": "error"},
    "download.dl_running":      {"ru": "⏳ Загрузка выполняется в фоне...", "en": "⏳ Download running in background..."},
